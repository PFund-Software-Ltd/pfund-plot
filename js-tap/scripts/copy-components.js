...
//
//   js-tap/dist/components/<name>.js  ->  pfund_plot/js_tap/components/<name>.js
//
...
// land under pfund_plot/js_tap/dashboards/ with their own packaging.)
...
const destDir = join(repoRoot, 'pfund_plot', 'js_tap', 'components')
...
for (const file of bundles) {
  ...
  console.log(`[copy-components] ${file} -> pfund_plot/js_tap/components/${file}`)
}
